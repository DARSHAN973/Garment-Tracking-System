<!-- Sidebar -->
<div class="fixed left-0 top-16 h-full w-64 bg-gray-900 text-white shadow-xl custom-scrollbar overflow-y-auto z-40">
  <div class="p-6">
    ...
    <div class="mb-8">
      ...
      <nav class="space-y-2">
        ...
        <a href="<?php echo dirname($_SERVER['PHP_SELF']) == '/' ? '' : '../'; ?>tcr/tcr_create.php" 
           class="flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-gray-800 transition-colors group">
